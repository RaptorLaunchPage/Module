...
export default function HomePage() {
  const { user, profile, signOut, signInWithDiscord } = useAuthV2() // Removed isLoading dependency
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              ...
              <CardContent className="space-y-4">
                <Button 
                  ...
                  className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
                >
